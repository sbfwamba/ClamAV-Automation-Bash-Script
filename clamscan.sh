#bash
#This is a bash script is used for scanning malicious files on Linux device using ClamAV antivirus
pdir=/define_yourdirectory/Clamscans #This is a parent directory
